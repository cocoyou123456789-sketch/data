# ARPES Explorer Versions

This file records stable snapshots discussed during development. Git tags with the same names are used where the corresponding commit is available locally.

| Version | Commit | Date | Notes |
| --- | --- | --- | --- |
| v0.1-literature-extractor | 0d2c166 | 2026-06-15 | Initial ARPES literature extractor scaffold. |
| v0.2-trusted-material-web | ee0fce1 | 2026-06-15 | Trusted material search web app. |
| v0.3-scholar-import | local history | 2026-06-16 | Google Scholar / BibTeX import workflow. |
