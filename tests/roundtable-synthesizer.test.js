...
assert.match(html, /<option value="doubao-ark-chat">Doubao Ark<\/option>/);
assert.match(html, /normalized\.startsWith\("doubao"\) \|\| normalized\.startsWith\("ark"\)/);
assert.match(html, /if \(provider === "ark"\) return "Doubao Ark";/);
assert.match(html, /aiState\.provider === "ark"/);
assert.match(html, /Volcengine Ark Chat Completions API/);
