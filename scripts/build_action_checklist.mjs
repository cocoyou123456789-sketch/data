...
const items = [
  ...
  ["A023", "2026-06-25", "生成调研报告时可选择 PDF、Word、Excel、Markdown 等格式", "报告导出", "High", "Done", "v1.1", "后续可接服务器端原生 PDF/Docx 生成", "用户要求报告格式可选"],
  ["A024", "2026-06-25", "修复可见 UI bug，并让页面更适合更多用户使用，同时不删除已有有用功能", "可用性/视觉修复", "High", "Done", "v1.2", "继续通过真实用户反馈微调导航和导出流程", "用户要求修复看到的 bug"],
...
const versions = [
  ...
  ["v1.0", "afeeeb5", "2026-06-25", "按手绘草图重排魔方和周期表工作台"],
  ["v1.1", "bdfd192", "2026-06-25", "报告导出格式可选"],
  ["v1.2", "c2ceb57", "2026-06-25", "顶部工具栏和报告导出入口可用性修复"],
  ["v1.3", "0a9f372", "2026-06-25", "周期表右侧 Module 圆桌导航"],
  ["v1.4", "91d132f", "2026-06-25", "完整 118 元素周期表显示"],
  ["v1.5", "current", "2026-06-25", "免费 ARPES API 元数据导入器"]
];
